...
public class Tabla extends Application {
    ...
    public void start(Stage stage) {
        ...
        stage.setTitle("Automatizaci�n I+D");
        stage.setWidth(1070);
        stage.setHeight(731);
        ...
        final Label label = new Label("Herramienta de Automatizaci�n");
        ...
        TableColumn firstNameCol = new TableColumn("Acci�n");
        ...
        addFirstName.setPromptText("Acci�n");
